...
#define LOOP_TIME 100000  //the time decalred is in microseconds
...
*/
float cpr = 3690;  //counts per revolution of the quadrature encoder
...
void setup() {
  ...
  attachInterrupt(0, do_count_LF, RISING);
  attachInterrupt(1, do_count_LR, RISING);
  attachInterrupt(5, do_count_right, RISING);
  //initialization of the arduino node
  nh.initNode();
